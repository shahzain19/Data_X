...
const Sidebar = ({fullName,avatar,email}:Props) => {
  ...
  return (
    <aside className='sidebar'>
      <Link href='/'>
        <Image src="/assets/images/xaxa.png" alt='Brand logo' width={100} height={100} className='hidden h-auto lg:block' />
        <Image src="/assets/images/xaxa.png" alt='Brand logo' width={100} height={100} className='lg:hidden' />
      </Link>
